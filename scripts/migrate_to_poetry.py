    ...
    def backup_current_setup(self) -> bool:
        ...
        try:
            ...
            if self.requirements_dir.exists():
                shutil.copytree(
                    self.requirements_dir, self.backup_dir / "requirements", dirs_exist_ok=True
                )
...
"""
    ...
    def generate_poetry_config(self, requirements: dict[str, list[Requirement]]) -> dict:
        ...
        poetry_config = {"tool": {"poetry": {"dependencies": {"python": "^3.11"}, "group": {}}}}
    ...
    def validate_migration(self) -> bool:
        ...
        try:
            ...
            result = subprocess.run(
                ["poetry", "check"], cwd=self.project_root, capture_output=True, text=True
            )
